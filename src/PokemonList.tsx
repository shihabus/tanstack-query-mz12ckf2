...
export default function PokemonList() { // fetch list and show as buttons
    const [pokemon, setPokemon] = useState < null | string > (null);
...
const PokemonDetails = ({pokemon} : {
    ...
    return (<> {/* accessed from placeholder */}
        <h4>Name: {pokemon}</h4>
        <Card/>
    </>);
};
